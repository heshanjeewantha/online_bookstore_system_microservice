...
const ProfilePage = () => {
  ...
  const formatDate = (dateValue) => new Date(dateValue).toLocaleDateString('en-LK', {
    year: 'numeric',
    month: 'long',
    day: 'numeric',
  });
      ...
      <div className="card p-8 mb-6 bg-white border border-slate-200 shadow-md">
        <div className="flex items-center gap-5 mb-8">
          ...
          <div>
            ...
            <span
              className={`inline-flex mt-2 items-center text-xs font-bold px-3 py-1 rounded-full ${
                user?.role === 'admin'
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          {[
            ...
            { label: 'Member Since', value: user?.createdAt ? formatDate(user.createdAt) : 'Not available' },
          ].map(({ label, value }) => (
